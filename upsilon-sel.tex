\begin{frame}[t]{The $\Upsilon$ selection}

almost the same as are usedAlsmost the same cuts as are used in the study
``Measurement of $\Upsilon$ production in $pp$ collisions at $\sqs=2.76\tev$'', \arxiv{1402.2539}
