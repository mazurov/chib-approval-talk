...
\scalebox{0.38}{
  ...
  \begin{picture}(150,140)
    %
    \put(0,0){
      \includegraphics[width=50mm, height=35mm]{cl_g_1p}
    }
    \put(50,0){
      \includegraphics[width=50mm, height=35mm]{cl_g_2p}
    }
    \put(100,0){
      \includegraphics[width=50mm, height=35mm]{cl_g_3p}
    }

    \put(0,35){
      \includegraphics[width=50mm, height=35mm]{c2_dtf_1p}
    }
    \put(50,35){
      \includegraphics[width=50mm, height=35mm]{c2_dtf_2p}
    }
    \put(100,35){
      \includegraphics[width=50mm, height=35mm]{c2_dtf_3p}
    }
    \put(0,70){
      \includegraphics[width=50mm, height=35mm]{pt_chib_1p}
    }
    \put(50,70){
      \includegraphics[width=50mm, height=35mm]{pt_chib_2p}
    }
    \put(100,70){
      \includegraphics[width=50mm, height=35mm]{pt_chib_3p}
    }
    \put(0,105){
      \includegraphics[width=50mm, height=35mm]{pt_ups_1p}
    }
    \put(50,105){
      \includegraphics[width=50mm, height=35mm]{pt_ups_2p}
    }
    \put(100,105){
      \includegraphics[width=50mm, height=35mm]{pt_ups_3p}
    }
