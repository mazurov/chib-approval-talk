...
\vbox{
\begin{itemize}
\item Free parameters:  yields and background parameters.
\item Fixed parameter: $\mu_{\chi_{b1}(1P)}$ to the value measured on combined 2011 and 2012 datasets.
\item Linked parameters for \chibone and \chibtwo signals:
    ...
    \item $N_{\chi_{b}} = \lambda N_{\chi_{b1}} + (1-\lambda) N_{\chi_{b2}}$\\($\lambda$ is fixed to 0.5)
...
\item Other linked parameters:    
    \begin{itemize}
        ...
        \item $\mu_{\chiboneThreeP} = \mu_{\chiboneOneP} + \Delta m_{\chi_{b1}(3P)}$\\
            \textcolor{blue}{($\Delta m_{\chi_{b1}(3P)}$ measured in this study)}
    \end{itemize}
\item Fixed parameters from MC study:
    \begin{itemize}
    \item $\sigma_{\chiboneOneP}$, $\frac{\sigma_{\chiboneTwoP}}{\sigma_{\chiboneOneP}}$,$\frac{\sigma_{\chiboneThreeP}}{\sigma_{\chiboneOneP}}$
