\begin{frame}{$\Upsilon$ yields as function of $p_T$}
  ...
  \begin{picture}(150,120)
    \put(0,0){
      \includegraphics[width=75mm, height=60mm]{N3S_scaledbylum}
    }
    \put(0,60){
      \includegraphics[width=75mm, height=60mm]{N1S_scaledbylum}
    }
    \put(75,60){
      \includegraphics[width=75mm, height=60mm]{N2S_scaledbylum}
    }
